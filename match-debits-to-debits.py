...
def create_matchbooks(our_df, bank_df, our_columns, bank_columns):
    our_value_column, bank_value_column = ('Debits', 'Debits')
...
class CSVMatcherApp:
    ...
    def match_csvs(self):
        ...
        matched_df = create_matchbooks(self.our_csv, self.bank_csv, our_columns, bank_columns)
        save_to_excel_with_color(matched_df, f"Matched_Output_OurDebits-TheirDebits_{self.file_month}.xlsx")
